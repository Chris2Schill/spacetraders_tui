...
void SellCargoRequest::validate()
{
    // TODO: implement validation
}

web::json::value SellCargoRequest::toJson() const
{
...
bool SellCargoRequest::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SellCargoRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SellCargoRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<TradeSymbol> SellCargoRequest::getSymbol() const
{
    return m_Symbol;
}

void SellCargoRequest::setSymbol(const std::shared_ptr<TradeSymbol>& value)
{
    m_Symbol = value;
    m_SymbolIsSet = true;
}

bool SellCargoRequest::symbolIsSet() const
{
    return m_SymbolIsSet;
}

void SellCargoRequest::unsetSymbol()
{
    m_SymbolIsSet = false;
}
int32_t SellCargoRequest::getUnits() const
{
    return m_Units;
}

void SellCargoRequest::setUnits(int32_t value)
{
    m_Units = value;
    m_UnitsIsSet = true;
}

bool SellCargoRequest::unitsIsSet() const
{
    return m_UnitsIsSet;
}

void SellCargoRequest::unsetUnits()
{
    m_UnitsIsSet = false;
}
}
