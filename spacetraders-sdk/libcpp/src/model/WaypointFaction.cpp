...
void WaypointFaction::validate()
{
    // TODO: implement validation
}

web::json::value WaypointFaction::toJson() const
{
...
bool WaypointFaction::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void WaypointFaction::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool WaypointFaction::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<FactionSymbol> WaypointFaction::getSymbol() const
{
    return m_Symbol;
}

void WaypointFaction::setSymbol(const std::shared_ptr<FactionSymbol>& value)
{
    m_Symbol = value;
    m_SymbolIsSet = true;
}

bool WaypointFaction::symbolIsSet() const
{
    return m_SymbolIsSet;
}

void WaypointFaction::unsetSymbol()
{
    m_SymbolIsSet = false;
}
}
