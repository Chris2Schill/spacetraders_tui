...
void Supply_construction_request::validate()
{
    // TODO: implement validation
}

web::json::value Supply_construction_request::toJson() const
{
...
bool Supply_construction_request::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Supply_construction_request::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Supply_construction_request::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Supply_construction_request::getShipSymbol() const
{
    return m_ShipSymbol;
}

void Supply_construction_request::setShipSymbol(const utility::string_t& value)
{
    m_ShipSymbol = value;
    m_ShipSymbolIsSet = true;
}

bool Supply_construction_request::shipSymbolIsSet() const
{
    return m_ShipSymbolIsSet;
}

void Supply_construction_request::unsetShipSymbol()
{
    m_ShipSymbolIsSet = false;
}
utility::string_t Supply_construction_request::getTradeSymbol() const
{
    return m_TradeSymbol;
}

void Supply_construction_request::setTradeSymbol(const utility::string_t& value)
{
    m_TradeSymbol = value;
    m_TradeSymbolIsSet = true;
}

bool Supply_construction_request::tradeSymbolIsSet() const
{
    return m_TradeSymbolIsSet;
}

void Supply_construction_request::unsetTradeSymbol()
{
    m_TradeSymbolIsSet = false;
}
int32_t Supply_construction_request::getUnits() const
{
    return m_Units;
}

void Supply_construction_request::setUnits(int32_t value)
{
    m_Units = value;
    m_UnitsIsSet = true;
}

bool Supply_construction_request::unitsIsSet() const
{
    return m_UnitsIsSet;
}

void Supply_construction_request::unsetUnits()
{
    m_UnitsIsSet = false;
}
}
