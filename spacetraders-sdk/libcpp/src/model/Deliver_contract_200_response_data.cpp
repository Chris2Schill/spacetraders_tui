...
#include "CppRestOpenAPIClient/model/Deliver_contract_200_response_data.h"

namespace models {



Deliver_contract_200_response_data::Deliver_contract_200_response_data()
{
...
void Deliver_contract_200_response_data::validate()
{
    // TODO: implement validation
}

web::json::value Deliver_contract_200_response_data::toJson() const
{
...
bool Deliver_contract_200_response_data::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Deliver_contract_200_response_data::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Deliver_contract_200_response_data::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Contract> Deliver_contract_200_response_data::getContract() const
{
    return m_Contract;
}

void Deliver_contract_200_response_data::setContract(const std::shared_ptr<Contract>& value)
{
    m_Contract = value;
    m_ContractIsSet = true;
}

bool Deliver_contract_200_response_data::contractIsSet() const
{
    return m_ContractIsSet;
}

void Deliver_contract_200_response_data::unsetContract()
{
    m_ContractIsSet = false;
}
std::shared_ptr<ShipCargo> Deliver_contract_200_response_data::getCargo() const
{
    return m_Cargo;
}

void Deliver_contract_200_response_data::setCargo(const std::shared_ptr<ShipCargo>& value)
{
    m_Cargo = value;
    m_CargoIsSet = true;
}

bool Deliver_contract_200_response_data::cargoIsSet() const
{
    return m_CargoIsSet;
}

void Deliver_contract_200_response_data::unsetCargo()
{
    m_CargoIsSet = false;
}
}
