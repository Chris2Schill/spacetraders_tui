...
void Navigate_ship_request::validate()
{
    // TODO: implement validation
}

web::json::value Navigate_ship_request::toJson() const
{
...
bool Navigate_ship_request::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Navigate_ship_request::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Navigate_ship_request::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Navigate_ship_request::getWaypointSymbol() const
{
    return m_WaypointSymbol;
}

void Navigate_ship_request::setWaypointSymbol(const utility::string_t& value)
{
    m_WaypointSymbol = value;
    m_WaypointSymbolIsSet = true;
}

bool Navigate_ship_request::waypointSymbolIsSet() const
{
    return m_WaypointSymbolIsSet;
}

void Navigate_ship_request::unsetWaypointSymbol()
{
    m_WaypointSymbolIsSet = false;
}
}
