...
#include "CppRestOpenAPIClient/model/Accept_contract_200_response_data.h"

namespace models {



Accept_contract_200_response_data::Accept_contract_200_response_data()
{
    m_AgentIsSet = false;
...
void Accept_contract_200_response_data::validate()
{
    // TODO: implement validation
}

web::json::value Accept_contract_200_response_data::toJson() const
{
...
bool Accept_contract_200_response_data::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Accept_contract_200_response_data::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Accept_contract_200_response_data::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Agent> Accept_contract_200_response_data::getAgent() const
{
    return m_Agent;
}

void Accept_contract_200_response_data::setAgent(const std::shared_ptr<Agent>& value)
{
    m_Agent = value;
    m_AgentIsSet = true;
}

bool Accept_contract_200_response_data::agentIsSet() const
{
    return m_AgentIsSet;
}

void Accept_contract_200_response_data::unsetAgent()
{
    m_AgentIsSet = false;
}
std::shared_ptr<Contract> Accept_contract_200_response_data::getContract() const
{
    return m_Contract;
}

void Accept_contract_200_response_data::setContract(const std::shared_ptr<Contract>& value)
{
    m_Contract = value;
    m_ContractIsSet = true;
}

bool Accept_contract_200_response_data::contractIsSet() const
{
    return m_ContractIsSet;
}

void Accept_contract_200_response_data::unsetContract()
{
    m_ContractIsSet = false;
}
}
