...
ScannedShip_reactor::ScannedShip_reactor()
{
...
void ScannedShip_reactor::validate()
{
    // TODO: implement validation
}

web::json::value ScannedShip_reactor::toJson() const
{
...
bool ScannedShip_reactor::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ScannedShip_reactor::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ScannedShip_reactor::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t ScannedShip_reactor::getSymbol() const
{
    return m_Symbol;
}

void ScannedShip_reactor::setSymbol(const utility::string_t& value)
{
    m_Symbol = value;
    m_SymbolIsSet = true;
}

bool ScannedShip_reactor::symbolIsSet() const
{
    return m_SymbolIsSet;
}

void ScannedShip_reactor::unsetSymbol()
{
    m_SymbolIsSet = false;
}
}
