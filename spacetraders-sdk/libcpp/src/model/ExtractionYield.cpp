...
void ExtractionYield::validate()
{
    // TODO: implement validation
}

web::json::value ExtractionYield::toJson() const
{
...
bool ExtractionYield::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void ExtractionYield::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ExtractionYield::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<TradeSymbol> ExtractionYield::getSymbol() const
{
    return m_Symbol;
}

void ExtractionYield::setSymbol(const std::shared_ptr<TradeSymbol>& value)
{
    m_Symbol = value;
    m_SymbolIsSet = true;
}

bool ExtractionYield::symbolIsSet() const
{
    return m_SymbolIsSet;
}

void ExtractionYield::unsetSymbol()
{
    m_SymbolIsSet = false;
}
int32_t ExtractionYield::getUnits() const
{
    return m_Units;
}

void ExtractionYield::setUnits(int32_t value)
{
    m_Units = value;
    m_UnitsIsSet = true;
}

bool ExtractionYield::unitsIsSet() const
{
    return m_UnitsIsSet;
}

void ExtractionYield::unsetUnits()
{
    m_UnitsIsSet = false;
}
}
