...
void Purchase_ship_request::validate()
{
    // TODO: implement validation
}

web::json::value Purchase_ship_request::toJson() const
{
...
bool Purchase_ship_request::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("shipType"))))
    {
        ...
        {
            std::shared_ptr<ShipType> refVal_setShipType;
...
void Purchase_ship_request::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Purchase_ship_request::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<ShipType> Purchase_ship_request::getShipType() const
{
    return m_ShipType;
}

void Purchase_ship_request::setShipType(const std::shared_ptr<ShipType>& value)
{
    m_ShipType = value;
    m_ShipTypeIsSet = true;
}

bool Purchase_ship_request::shipTypeIsSet() const
{
    return m_ShipTypeIsSet;
}

void Purchase_ship_request::unsetShipType()
{
    m_ShipTypeIsSet = false;
}
utility::string_t Purchase_ship_request::getWaypointSymbol() const
{
    return m_WaypointSymbol;
}

void Purchase_ship_request::setWaypointSymbol(const utility::string_t& value)
{
    m_WaypointSymbol = value;
    m_WaypointSymbolIsSet = true;
}

bool Purchase_ship_request::waypointSymbolIsSet() const
{
    return m_WaypointSymbolIsSet;
}

void Purchase_ship_request::unsetWaypointSymbol()
{
    m_WaypointSymbolIsSet = false;
}
}
