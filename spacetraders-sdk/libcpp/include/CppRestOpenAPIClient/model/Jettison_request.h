...
#ifndef MODELS_Jettison_request_H_
#define MODELS_Jettison_request_H_
...
/// 
/// </summary>
class  Jettison_request
    : public ModelBase
{
public:
    Jettison_request();
    virtual ~Jettison_request();
...
#endif /* MODELS_Jettison_request_H_ */
