...
#ifndef MODELS_Siphon_H_
#define MODELS_Siphon_H_
...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<SiphonYield> getYield() const;
    bool yieldIsSet() const;
    void unsetYield();

    void setYield(const std::shared_ptr<SiphonYield>& value);


protected:
    utility::string_t m_ShipSymbol;
    bool m_ShipSymbolIsSet;
    std::shared_ptr<SiphonYield> m_Yield;
    bool m_YieldIsSet;
};
