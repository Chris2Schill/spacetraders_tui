...
#ifndef MODELS_Jump_ship_request_H_
#define MODELS_Jump_ship_request_H_
...
/// 
/// </summary>
class  Jump_ship_request
    : public ModelBase
{
public:
    Jump_ship_request();
    virtual ~Jump_ship_request();
...
#endif /* MODELS_Jump_ship_request_H_ */
