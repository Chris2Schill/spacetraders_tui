...
/*
 * Navigate_ship_request.h
 *
 * 
 */

#ifndef MODELS_Navigate_ship_request_H_
#define MODELS_Navigate_ship_request_H_
...
/// 
/// </summary>
class  Navigate_ship_request
    : public ModelBase
{
public:
    Navigate_ship_request();
    virtual ~Navigate_ship_request();
...
#endif /* MODELS_Navigate_ship_request_H_ */
