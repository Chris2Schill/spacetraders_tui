...
void SystemFaction::validate()
{
    // TODO: implement validation
}

web::json::value SystemFaction::toJson() const
{
...
bool SystemFaction::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void SystemFaction::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool SystemFaction::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<FactionSymbol> SystemFaction::getSymbol() const
{
    return m_Symbol;
}

void SystemFaction::setSymbol(const std::shared_ptr<FactionSymbol>& value)
{
    m_Symbol = value;
    m_SymbolIsSet = true;
}

bool SystemFaction::symbolIsSet() const
{
    return m_SymbolIsSet;
}

void SystemFaction::unsetSymbol()
{
    m_SymbolIsSet = false;
}
}
