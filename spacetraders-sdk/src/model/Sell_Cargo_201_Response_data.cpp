...
Sell_Cargo_201_Response_data::Sell_Cargo_201_Response_data()
{
    m_AgentIsSet = false;
    m_CargoIsSet = false;
...
void Sell_Cargo_201_Response_data::validate()
{
    // TODO: implement validation
}

web::json::value Sell_Cargo_201_Response_data::toJson() const
{
...
bool Sell_Cargo_201_Response_data::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Sell_Cargo_201_Response_data::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Sell_Cargo_201_Response_data::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<Agent> Sell_Cargo_201_Response_data::getAgent() const
{
    return m_Agent;
}

void Sell_Cargo_201_Response_data::setAgent(const std::shared_ptr<Agent>& value)
{
    m_Agent = value;
    m_AgentIsSet = true;
}

bool Sell_Cargo_201_Response_data::agentIsSet() const
{
    return m_AgentIsSet;
}

void Sell_Cargo_201_Response_data::unsetAgent()
{
    m_AgentIsSet = false;
}
std::shared_ptr<ShipCargo> Sell_Cargo_201_Response_data::getCargo() const
{
    return m_Cargo;
}

void Sell_Cargo_201_Response_data::setCargo(const std::shared_ptr<ShipCargo>& value)
{
    m_Cargo = value;
    m_CargoIsSet = true;
}

bool Sell_Cargo_201_Response_data::cargoIsSet() const
{
    return m_CargoIsSet;
}

void Sell_Cargo_201_Response_data::unsetCargo()
{
    m_CargoIsSet = false;
}
std::shared_ptr<MarketTransaction> Sell_Cargo_201_Response_data::getTransaction() const
{
    return m_Transaction;
}

void Sell_Cargo_201_Response_data::setTransaction(const std::shared_ptr<MarketTransaction>& value)
{
    m_Transaction = value;
    m_TransactionIsSet = true;
}

bool Sell_Cargo_201_Response_data::transactionIsSet() const
{
    return m_TransactionIsSet;
}

void Sell_Cargo_201_Response_data::unsetTransaction()
{
    m_TransactionIsSet = false;
}
}
