...
Get_system_waypoints_200_response::Get_system_waypoints_200_response()
{
    m_DataIsSet = false;
    m_MetaIsSet = false;
}
...
void Get_system_waypoints_200_response::validate()
{
    // TODO: implement validation
}

web::json::value Get_system_waypoints_200_response::toJson() const
{
...
bool Get_system_waypoints_200_response::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("data"))))
    {
        ...
        {
            std::vector<std::shared_ptr<Waypoint>> refVal_setData;
...
void Get_system_waypoints_200_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Get_system_waypoints_200_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<std::shared_ptr<Waypoint>>& Get_system_waypoints_200_response::getData()
{
    return m_Data;
}

void Get_system_waypoints_200_response::setData(const std::vector<std::shared_ptr<Waypoint>>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool Get_system_waypoints_200_response::dataIsSet() const
{
    return m_DataIsSet;
}

void Get_system_waypoints_200_response::unsetData()
{
    m_DataIsSet = false;
}
std::shared_ptr<Meta> Get_system_waypoints_200_response::getMeta() const
{
    return m_Meta;
}

void Get_system_waypoints_200_response::setMeta(const std::shared_ptr<Meta>& value)
{
    m_Meta = value;
    m_MetaIsSet = true;
}

bool Get_system_waypoints_200_response::metaIsSet() const
{
    return m_MetaIsSet;
}

void Get_system_waypoints_200_response::unsetMeta()
{
    m_MetaIsSet = false;
}
}
