...
void WaypointOrbital::validate()
{
    // TODO: implement validation
}

web::json::value WaypointOrbital::toJson() const
{
...
bool WaypointOrbital::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void WaypointOrbital::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool WaypointOrbital::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t WaypointOrbital::getSymbol() const
{
    return m_Symbol;
}

void WaypointOrbital::setSymbol(const utility::string_t& value)
{
    m_Symbol = value;
    m_SymbolIsSet = true;
}

bool WaypointOrbital::symbolIsSet() const
{
    return m_SymbolIsSet;
}

void WaypointOrbital::unsetSymbol()
{
    m_SymbolIsSet = false;
}
}
